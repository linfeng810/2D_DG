module gmsh_io
  ...
  private :: ch_cap, ch_eqi, ch_to_digit, get_unit, i4mat_copy, i4mat_transpose_print, &
    i4mat_transpose_print_some, mesh_base_one, r8mat_copy, r8mat_transpose_print, &
    r8mat_transpose_print_some, s_begin, s_to_i4, s_to_r8, timestamp
  public :: gmsh_data_read, &
    gmsh_mesh1d_write, gmsh_mesh2d_element_data_example, gmsh_mesh2d_element_size_example, &
    gmsh_mesh2d_node_data_example, gmsh_mesh2d_node_size_example, gmsh_mesh2d_write, &
    gmsh_mesh3d_write, gmsh_size_read
...
!
  ...
  integer length
  integer level
  real ( kind = rk ) node_x(node_dim,node_num)
...
!
  ...
  integer gmsh_unit
  integer node
  real ( kind = rk ) node_x(m,node_num)
  integer tag_num
  integer tag1
!
...
!
  ...
  real ( kind = rk ) node_x(node_dim,node_num)
  real ( kind = rk ), dimension ( 2, 21 ) :: node_x_save = reshape ( (/ &
    0.0, 0.0, &
    1.0, 0.0, &
    2.0, 0.0, &
    3.0, 0.0, &
...
!
  ...
  character * ( * ) gmsh_filename
  integer gmsh_unit
  integer, dimension ( 20 ) :: leo_to_gmsh = (/ &
     1,  2,  3,  4,  5, &
     7, 10, 11,  8,  6, &
    12, 18, 19, 13, 20, &
    14,  9, 15, 16, 17 /)
  integer node
  real ( kind = rk ) node_x(3,node_num)
  integer tag_num
  integer tag1
!
!  Enforce 1-based indexing of nodes.
...
logical function s_begin ( s1, s2 )
